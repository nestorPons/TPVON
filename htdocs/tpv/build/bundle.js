...
required(){this.el.removeChild(this.o[0])}}class MyInput{constructor(id){this.id=id;this.component=document.getElementById(id);this.el=this.component.getElementsByTagName('input')[0]}
value(value=null){if(value)this.el.value=value;return this.el.value}}class MyCheckbox{constructor(id){this.id=id;this.component=document.getElementById(id);this.el=this.component.getElementsByTagName('input')[0]}
...
required(){this.el.removeChild(this.o[0])}}class Table{constructor(id){this.el=document.getElementById(id).querySelector('table')
this.body=this.el.getElementsByTagName('tbody')[0]
this.template=document.getElementById(id).querySelector('template')
this.$table=$('#'+id).find('table')
this.$template=$(`#${id}`).find('template')
...
return this.el.classList.contains('hoverable')}
html(){return this.el.innerHTML}}class Modal{constructor(id){this.el=document.getElementById(id).querySelector(`.card`);this.$el=$('#'+id).find('.card')
