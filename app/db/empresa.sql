CREATE TABLE `empresa` (
  ...
  `id_admin` int(11), 
  `id_usuario_facturacion` int(11) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE, 
  `id_direccion` int(22) REFERENCES `direcciones` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
